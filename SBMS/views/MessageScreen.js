        ...
        <View className="mt-5 mx-7">
          {
            ...
            <View>
              ...
              <PersonalMessage userName="Huy Le Dinh" content="hi friend" date="12/2/2024" seen = {true} ></PersonalMessage>
              <PersonalMessage userName="Huy Dinh Le" content="hi friend" date="12/2/2025" seen = {false} ></PersonalMessage>
            </View>
            :
            <View>
              <Text>3 messages</Text>
              <SystemMessage content="hi friend" date="12/2/2024" seen = {true} ></SystemMessage>
              <SystemMessage content="hi friend" date="12/2/2025" seen = {false} ></SystemMessage>
              <SystemMessage content="hi friend" date="12/2/2025" seen = {false} ></SystemMessage>
            </View>
          }
        </View>
